...
import { EventIntroScene, type EventIntroProps } from '../components/EventIntroScene'
...
// (EventIntroScene vive en components/EventIntroScene.tsx — la comparten el
// render server-side y el preview en vivo del editor)
